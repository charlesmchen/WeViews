...
/**
 * A subclass of UIButton with some added convenience methods.
 */
@interface WeButton : UIButton <IWeView> {
}

/**
 * The handler group to be fired on click.
 *
 * See IHandler.
 */
@property (nonatomic, retain) HandlerGroup* handlerGroup;
 ...
 * @return A WeButton.
 */
+ (WeButton*) createWithImage :(NSString*) upImageName;
 ...
 * @return A WeButton.
 */
+ (UIButton*) createTextButton:(NSString*) text
                          font:(UIFont*) font
                         color:(UIColor*) color
                        target:(id) target
                      selector:(SEL) selector;
...
/**
 * Sets the down/selected image by filename.
 *
 * @param imageName the image name.
 * @return Itself, for chaining.
 */
- (WeButton*) setDownImage :(NSString*) imageName;

/**
 * Adds a handler to be fire when the button is clicked.
 *
 * See IHandler.
 *
 ...
 * @return Itself, for chaining.
 */
- (WeButton*) addClickHandler:(id<IHandler>) handler;

/**
 * Adds a selector to be performed when the button is clicked.
 *
 * See IHandler.
 *
 * @param target The target.
 ...
 * @return Itself, for chaining.
 */
- (WeButton*) addClickSelector:(SEL) selector
                       target:(id) target;

/**
 * Adds a selector to be performed with the argument when the button is clicked.
 *
 * See IHandler.
 *
 * @param target The target.
...
/**
 * Adds a NSNotification message to be sent when the button is clicked.
 *
 * @param name the notification name.
 * @return Itself, for chaining.
 */
- (WeButton*) addSimpleNotification :(NSString*) name;
