 ...
 * See WeLink.
 */
@interface WeLabel : UILabel <IWeView>
 ...
 *
 * @param value The stretchWeight value.
 * @return Itself, for chaining.
 */
- (WeLabel*) withStretchWeight :(CGFloat) value;

/**
 * Sets the stretchWeight property to 1.0f (the default value).
 *
 * @return Itself, for chaining.
 */
- (WeLabel*) withStretch;
