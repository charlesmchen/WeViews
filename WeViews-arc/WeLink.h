 ...
 * See WeLabel.
 */
@interface WeLink : WeLabel <IWeView> {
    BOOL isDown;
}
 ...
 * @param text The text.
 * @param font The font.
 * @param upColor The up color.
 * @param downColor The down color.
 * @return A WeLink.
 */
...
/**
 * Adds a handler to be fire when the link is clicked.
 *
 * See IHandler.
 *
...
/**
 * Adds a selector to be performed when the link is clicked.
 *
 * See IHandler.
 *
...
/**
 * Adds a selector to be performed with the argument when the link is clicked.
 *
 * See IHandler.
 *
 * @param target The target.
