...
+ (ResizeCorner*) create {
    ResizeCorner* result = [[[ResizeCorner alloc] init] autorelease];
    result.backgroundColor = [UIColor colorWithWhite:0.5f alpha:0.5f];
    result.opaque = YES;
    setUIViewSize(result, CGSizeMake(RESIZE_CORNER_SIZE, RESIZE_CORNER_SIZE));
    return result;
}
