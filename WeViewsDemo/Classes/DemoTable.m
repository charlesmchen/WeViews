...
+ (DemoTable*) create:(int) rowCount {
    DemoTable* result = [[[DemoTable alloc] initWithFrame:CGRectZero
    ...
    result.opaque = YES;
    result.separatorColor = [UIColor whiteColor];
    result.separatorStyle = UITableViewCellSeparatorStyleSingleLineEtched;
    result.indicatorStyle = UIScrollViewIndicatorStyleWhite;
...
- (UITableViewCell*) tableView:(UITableView*) tableView cellForRowAtIndexPath:(NSIndexPath*) indexPath {
    ...
    NSString* title = [NSString stringWithFormat:@"Dummy cell: %d", [indexPath row]];
