...
typedef enum {
    TOUCH_MODE_MOVE = 0,
    TOUCH_MODE_RESIZE_UPPER_LEFT = 1,
    TOUCH_MODE_RESIZE_UPPER_RIGHT = 2,
    TOUCH_MODE_RESIZE_LOWER_LEFT = 3,
    TOUCH_MODE_RESIZE_LOWER_RIGHT = 4,
} TouchMode;
...
@interface Canvas : WePanel <UIGestureRecognizerDelegate> {
    CGPoint downPoint;
