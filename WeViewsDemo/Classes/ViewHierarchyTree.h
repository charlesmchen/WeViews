...
@interface ViewHierarchyTree : WePanel <UITableViewDelegate, UITableViewDataSource>

@property (retain, nonatomic) UITableView* table;
@property (retain, nonatomic) WindowModel* windowModel;
@property (retain, nonatomic) NSMutableArray* visibleViews;
@property (retain, nonatomic) NSMutableArray* indents;
@property (retain, nonatomic) NSMutableSet* expandedViews;
