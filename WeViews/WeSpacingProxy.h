...
/**
 * A (usually invisible) spacer whose natural size and stretch properties reflects
 * another view. Useful for symmetrically "balancing" a layout.
 */
@interface WeSpacingProxy : WeView
