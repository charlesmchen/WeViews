...
#import "WeViewOption.h"

// TODO: this class needs to be re-thought.
/**
 * An alternative to UIActionSheet. 
 *
 * @bug This class is broken and needs to be re-thought.
 */
@interface WeActionSheet : WeBaseObject <UIActionSheetDelegate> {
}
...
@property (nonatomic, retain) id dismissTarget;
