...
/**
 * The scrolling mode of WeScrollView.
 */
typedef enum {
...
/**
 * A subclass of UIScrollView for scrolling a given UIView.
 */
 ...
 * The scroll mode.
 */
@property (nonatomic, assign) FScrollMode mode;
...
/**
 * The minimum size of the UIScrollView.
 */
 ...
 * Factory method.
 *
 * @param value The scroll content.
 * @return A WeScrollView.
 */
...
/**
 * Resets the content's size and the contentSize property.
 * Also enables or disables scrolling as necessary.
 */
- (void) layoutContents;
