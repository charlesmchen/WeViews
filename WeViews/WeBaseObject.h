...
/**
 * Purge all memory references of this object.
 * 
 * Typically, we'll want to call [purge] on referenced objects before releasing them.
 *
 * Called by [NSObject dealloc], but should be able to be safely called more than once.
 */
- (void) purge;
