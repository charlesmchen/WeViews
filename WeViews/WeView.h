...
/**
 * Add a selector to performed for a given set of events.
 *
 * See IHandler.
 *
...
/**
 * Add a selector to performed when the view is clicked.
 *
 * See IHandler.
 *
 * @param target The target.
...
/**
 * Sets the stretch weight to 1.0f, the default stretch value if value is YES and
 * to 0.0f if value is NO.
 *
 * See [IWeView stretchWeight].
 *
 * @param value A boolean indicating whether or not the view can stretch.
 */
