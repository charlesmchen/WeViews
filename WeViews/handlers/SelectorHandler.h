...
/**
 * Event handler that performs a selector with an optional argument.
 *
 * See IHandler.
 *
 * @warning This class retains its target, which can lead to cyclical references.
 */
@interface SelectorHandler : WeBaseObject <IHandler>
 ...
 * Factory method.
 *
 * @param target The selector target.
 * @param selector The selector.
 * @param argument An optional argument.
 */
+ (SelectorHandler*) create:(id) target
