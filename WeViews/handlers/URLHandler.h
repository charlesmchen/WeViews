...
/**
 * Event handler that opens a URL in Safari.
 *
 * Local file handling is incomplete.
 *
 * See IHandler.
 */
@interface URLHandler : WeBaseObject <IHandler>
...
/**
 * Flag indicating whether the URL should be opened locally.
 *
 * @warning This functionality is broken.
 */
@property (nonatomic, assign) BOOL isLocalFile;

/**
 * The UIView to use when opening locally.
 *
 * @warning This functionality is broken.
 */
...
/**
 * The dialog used when opening locally.
 *
 * @warning This functionality is broken.
 */
@property (nonatomic, retain) UIView* dialog;
 ...
 * @param view the parent UIView to use when opening locally.
 *
 * @warning This functionality is broken.
 */
