...
+ (URLHandler*) create :(NSString*) url {
    URLHandler* result = [[[URLHandler alloc] init] autorelease];
 ...
 */
- (void) openFileUrl {
    self.view = [self findUIWindow:view];

    CGRect frame = [view frame];
    frame.origin = CGPointZero;
    self.dialog = [[[UIView alloc] initWithFrame:frame] autorelease];
    dialog.opaque = YES;
...
//    int buttonHeight = 48;
    ...
    UIWebView *webView = [[[UIWebView alloc] initWithFrame:CGRectInset(CGRectMake(0, 0,
                                                                       ...
                                                                       DIALOG_WEB_VIEW_PADDING)] autorelease];
    NSURLRequest *req = [NSURLRequest requestWithURL:url];
    [webView loadRequest:req];
    [dialog addSubview:webView];
