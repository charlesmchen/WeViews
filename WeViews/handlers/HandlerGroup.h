...
/**
 * A group of handlers that are invoked together.
 *
 * See IHandler.
 */
@interface HandlerGroup : WeBaseObject <IHandler>

/**
 * The group's handlers.
 */
 ...
 * Factory method.
 *
 * @param handlers Handlers to add to the group.
 */
+ (HandlerGroup*) create :(NSArray*) handlers;

/**
 * Add a handler.
 *
 * @param handler A Handler to add to the group.
 */
