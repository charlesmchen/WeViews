...
+ (WeImageView*) createWithImage:(UIImage*) image {
    WeImageView* result = [[[WeImageView alloc] init] autorelease];
    [result setImage:image];
    [result sizeToFit];
    return result;
}

+ (WeImageView*) create:(NSString*) imageName {
    return [self createWithImage:[WeViews loadImage:imageName]];
}

- (WeImageView*) withOpaque :(BOOL) value {
    self.opaque = value;
    return self;
}
