 ...
 *
 * Doesn't actually lay out its contents.
 *
 * The "natural size" is the space used by its contents.
 */
@interface WePanelLayoutManual : WePanelLayout
