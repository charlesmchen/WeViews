...
#import "WePanelLayoutManual.h"
#import "WePanelLayer.h"
#import "WeMacros.h"


@implementation WePanelLayoutManual

+ (WePanelLayoutManual*) create {
    WePanelLayoutManual* result = [[[WePanelLayoutManual alloc] init] autorelease];
    return result;
}
...
- (CGSize) sizeThatFits:(CGSize) size
    ...
    int maxX, maxY;
    BOOL hasValue = NO;
    for (UIView* view in layer.views) {
