 ...
 *
 * Any extra space from rounding errors is distributed evenly among the views.
 *
 ...
 */
@interface WePanelLayoutFillGrid : WePanelLayoutGridBase
 ...
 * @return A WePanelLayoutFillGrid.
 */
