...
/**
 * Base class for grid layouts.
 *
 * Has either columnCount or rowCount.  The other is calculated
 * based on the number of items.
 */
@interface WePanelLayoutGridBase : WePanelLayout {
    int rowOrColumnCount;
    BOOL hasRowCount;
}

/**
 * If YES, all columns have width of widest column and all rows have height 
 * of tallest row.
 *
 * This property isn't honored by all subclasses of this class.
 */
@property (nonatomic, assign) BOOL uniformGrid;

/**
 * @return Column count, if set; otherwise zero.
 */
- (int) columnCount;

/**
 * @return Row count, if set; otherwise zero.
 */
- (int) rowCount;

/**
 * Sets the column count and places the layout in "fixed column count" mode.
 *
 * @param value the column count value.
 */
- (void) setColumnCount:(int) value;

/**
 * Sets the row count and places the layout in "fixed row count" mode.
 *
 * @param value the row count value.
 */
- (void) setRowCount:(int) value;

/**
 * Given a WePanelLayer, calculate the current row and column count.
 *
...
/**
 * Given a WePanelLayer, calculate the current layout information.
 *
 * @param layer The WePanelLayer.
 */
 ...
 * @param columnLefts The column left values.
 * @param rowTops The row top values.
 * @param columnWidths The column width values.
 * @param rowHeights The row height values.
 */
