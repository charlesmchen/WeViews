...
/**
 * The "spacing grid" layout strategy.
 *
 ...
 * the layer.
 *
 * See WePanelLayoutNaturalGrid, WePanelLayoutFillGrid.
 *
 * @warning Doesn't perform well at scale.
 */
@interface WePanelLayoutSpacingGrid : WePanelLayoutGridBase
 ...
 * @return A WePanelLayoutSpacingGrid.
 */
