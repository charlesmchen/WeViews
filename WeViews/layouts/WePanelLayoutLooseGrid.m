...
@implementation WePanelLayoutLooseGrid

+ (WePanelLayoutLooseGrid*) createWithColumnCount:(int) columnCount
                                    uniformGrid:(BOOL) uniformGrid {
    WePanelLayoutLooseGrid* result = [[[WePanelLayoutLooseGrid alloc] init] autorelease];
