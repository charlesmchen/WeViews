 ...
 *
 * The "natural size" is the maximum size of any of its contents.
 */
@interface WePanelLayoutSimple : WePanelLayout

/**
 * The layout mode.
 */
@property (nonatomic, assign) LayoutMode mode;
 ...
 * @return A WePanelLayoutSimple.
 */
+ (WePanelLayoutSimple*) create:(LayoutMode) mode;
